---
name: pointapp-builder-audit-issues
description: 'Audit and correct PointApp Builder backlog Issue classification. Use when the PM asks to audit, reprioritize, clean up, or validate the backlog without starting implementation.'
---

# Audit the PointApp Builder Backlog

Read `AGENTS.md`, `.agents/pointapp-builder-pipeline-policy.html`, the live Project fields, every Backlog Issue, all open pull requests, live labels, and relevant duplicate or dependency evidence.
