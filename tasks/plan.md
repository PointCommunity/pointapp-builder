...
- Treat PRs #7 through #11 as the only pre-pipeline bootstrap exceptions and reject any later ungoverned PR.
...
5. Add failing tests for PointApp health, copied Canary drift, full labels, and the exact PR #7 through PR #11 exceptions; implement until green.
...
- Current PR conflict: preserve PRs #7 through #11 and audit them as temporary exact exceptions.
